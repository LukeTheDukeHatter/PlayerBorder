...
execute unless score setupflag dp_setup matches 5 run scoreboard players set multiplier worldBorderSize 40
execute unless score setupflag dp_setup matches 5 run scoreboard players set MinSize worldBorderSize 20
execute unless score setupflag dp_setup matches 5 run scoreboard players set MaxSize worldBorderSize 1000
